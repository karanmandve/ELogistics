...
{
    /// <inheritdoc />
    public partial class addedinvoiceandsalestable : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Distributors_States_StateId",
                        column: x => x.StateId,
                        principalTable: "States",
                        principalColumn: "StateId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Distributors_UserTypes_UserTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductMRP = table.Column<decimal>(type: "decimal(11,2)", nullable: false),
                    ProductRate = table.Column<decimal>(type: "decimal(11,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CartMasters_Customers_CustomerId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InvoicePdfLink = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CartDetails_CartMasters_CartId",
                        column: x => x.CartId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SalesDetails_Invoices_InvoiceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CartMasters_CustomerId",
                table: "CartMasters",
                column: "CustomerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Distributors_UserTypeId",
                table: "Distributors",
                column: "UserTypeId");
